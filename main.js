    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (catalogViewport && packTabsContainer && catalogGrid) {
            ...
            const ecoProducts = [
                ...
                { brand: 'eco', pack: '15', subcat: '', product: 'Aroma', img: 'img/ECO/15/aroma-15.jpg', color: 'linear-gradient(135deg, #00838f 0%, #006064 100%)', isDark: true },
            ...
            function selectBrand(brandId) {
                ...
                if (brandBannersSection && brandBannersSection.style.display !== 'none') {
                    ...
                    gsap.set(compactBrandBar, { display: 'block' });
            ...
            function showComingSoonOverlay() {
                ...
                // Hide brand selection elements because other categories don't have brand filtering yet
